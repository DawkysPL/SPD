...
namespace SPD_z_wizualizacją
{
    class Algorytmy
    {
       ...
       4. Odbijamy lustrzanie szereg elementów od indeksu i+1 do końca szeregu.
        ...
        #endregion
        #region Johnson
        public static int[,] johnsonAlgoritmForTwoMachine(List<Maszyna> Maszyny)
        {
        ...
        public static int[,] johnsonAlgoritmForThreeMachine(List<Maszyna> Maszyny)
        {
        ...
        public static int[,] johnsonAlgoritm(List<Maszyna> Maszyny)
        {
            if (Maszyna.liczbaMaszyn == 2)
            {
                return johnsonAlgoritmForTwoMachine(Maszyny);
            }
            else if (Maszyna.liczbaMaszyn == 3)
            {
                return johnsonAlgoritmForThreeMachine(Maszyny);
            }
